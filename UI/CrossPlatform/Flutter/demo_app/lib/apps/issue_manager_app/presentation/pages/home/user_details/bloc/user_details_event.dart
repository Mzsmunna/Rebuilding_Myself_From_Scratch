...
class OnChangeUserDetailsEvent extends UserDetailsEvent {
...
class OnSubmitUserDetailsEvent extends UserDetailsEvent {
  final UserModel userModel;
  final String confirmPassword;
  const OnSubmitUserDetailsEvent(
      {required this.userModel, required this.confirmPassword});
}

class OnLoginNavigateUserDetailsEvent extends UserDetailsEvent {
  final String email;
  final String password;
  const OnLoginNavigateUserDetailsEvent(
